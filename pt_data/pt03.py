# -*- coding: utf-8 -*-
"""
Created on Mon May 20 20:47:34 2019
...
for f_name in f_names :
    ...
    p00 = (6.81277060e+00, 2.39961218e+03, 1.17, 2.98549758e+04, 0.51, 2.74938847e+01)
    ...
    plt.title('Exponential Fit of TRPL data (CsPbBr3)', fontsize=20)
    plt.text(31, -400, 'p00 : {0}'.format(p00), horizontalalignment='left', verticalalignment='center')
    plt.text(31, -700, 'popt : {0}'.format(popt), horizontalalignment='left', verticalalignment='center')
    plt.text(45, -400,'x-axis : ns')
    plt.text(45, -700,'y-axis : a.u.')
    if  save_chart == True :
