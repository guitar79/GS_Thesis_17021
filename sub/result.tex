...
\begin{center}
	\begin{tabular}{ccc}
		...
		ymajorgrids = true,
		legend style={at={(0.02,10)}},legend pos=north west]%
		\addplot[pattern=north east lines, pattern color=red] table [x=pt, y=tau1] {./ND_data/nd0_1.csv}; \addlegendentry {tau 1},%
		...
		ymajorgrids = true,
		legend style={at={(0.02,10)}},legend pos=north west]%
		\addplot [pattern=north east lines, pattern color=red]table [x=pt, y=tau1] {./ND_data/nd0_2.csv}; \addlegendentry {tau 1},%
		\addplot [pattern=north west lines, pattern color=blue] table [x=pt, y=tau2]
