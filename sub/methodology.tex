...
\begin{figure}[h]
	...
	\end{center}
		...
		\label{fig:FIR102}
\end{figure}
또, Sonication으로 세척한 Silicon wafer 위에 $\rm{O_2}$ plasma를 이용하여 코팅한 후 2000rpm으로 1분간 spin coating을 이용하여 용액을 균일하게 펼쳐주었다. 마지막으로 미리 \SI{100}{\celsius}로 달궈놓았던 핫플레이트에서 5분간 PDMS를 이용하여 눌러주었다. PDMS위에 200g의 무게를 올려놓아 stamping이 잘 일어나도록 하였다. \\
